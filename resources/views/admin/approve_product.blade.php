...
@section('title','Approved Product')
@section('content')
    <div class="header-bg">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title"> <i class="dripicons-blog"></i> Approved Product</h4>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0"
                                ...
                                @foreach($product as $products)
                                    <tr>
                                        ...
                                        <td> <button
                                                onclick="window.location.href='{{route('AdminProductStatus','unapproved='.base64_encode($products->id))}}'"
                                                type="button" class="btn btn-outline-pink waves-effect waves-light">Unapproved</button></td>
                                    </tr>
                                @endforeach
