            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title"> <i class="dripicons-blog"></i> All Sub Category</h4>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered" cellspacing="0" width="100%" >
                                ...
                                @foreach($subcategory as $subcategories)
                                    <tr>
                                        ...
                                        <td>
                                            <button
                                                href="{{route('AdminSubcategoryDelete','delete='.base64_encode($subcategories->id))}}"
                                                type="button" class="delete btn btn-outline-dark waves-effect waves-light">Delete</button>
                                        </td>
                                    </tr>
                                    @php $list++; @endphp
                                @endforeach
